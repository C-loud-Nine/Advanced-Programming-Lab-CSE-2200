...
public class Addmoney extends AppCompatActivity {
    ...
    TextInputLayout addmoni;
    Button depsitbtn,backaddmoni;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addmoni = findViewById(R.id.addamount);
        depsitbtn = findViewById(R.id.btnaddmoni);
        backaddmoni= findViewById(R.id.btn_addmoni_back);


        depsitbtn.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        backaddmoni.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private Boolean amount_valid() {
        String val = addmoni.getEditText().toString();
        if (val.isEmpty()) {
            addmoni.setError("Field Cannot be Empty");
            return false;
        }
        else {
            addmoni.setError(null);
            addmoni.setErrorEnabled(false);
            return true;
        }
    }
...
//    }
    ...
    private boolean isWithdrawn() {
        final String enteredAmount = addmoni.getEditText().getText().toString().trim();
        SharedPreferences sharedPreferences = getSharedPreferences("UserData", MODE_PRIVATE);
        ...
        if (int_enteredAmount < 100000) {
            ...
            transactionHistoryRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    Transaction transaction = new Transaction("Credited", enteredAmount, getCurrentDate());
    ...
    public void okAmount(){
        if(isWithdrawn()){
            ...
            addmoni.setError("Wrong Amount");
            addmoni.requestFocus();
        }
    }
